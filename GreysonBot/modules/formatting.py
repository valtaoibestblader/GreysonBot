from GreysonBot.modules.helper_funcs.decorators import kigyocallback
...
@greysoncallback(pattern=r"fmt_help_")
def fmt_help(update: Update, context: CallbackContext):
    ...
    query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton(text='Report Error', url='https://t.me/GreysonChats')]]
        ),
    )
