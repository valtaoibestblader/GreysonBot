...
""",
    ...
    "send-help": """Hey! Benim adım Filtre. Ben birçok özel özelliğe sahip Filtre botuyum.
*Yararlı komutlar* :
✪ /start : beni yeniden başlat
✪ /help : tüm modülleri ve komutları kontrol edin
✪ /connect (grup kimliği): Grubunuzu bağlayın
✪ /source : Kaynağımla ilgili ayrıntıları kontrol edin .
   {}
   """,
